 ...
 *
 * It was measured at 570px against the reference; it now takes `min-h-svh`
...
export function Statement() {
  ...
  return (
    <section className="section-mask relative flex min-h-svh w-full items-center justify-center overflow-hidden bg-ink text-[var(--c-white)]">
